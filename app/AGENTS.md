...
- The watchdog is log-only for lulls and recoveries (a quiet mesh comes and goes); it toasts only when it acts -- a confirmed stall that triggers a reconnect or a reboot.
