...
- **Read by group, not all at once.** Each setting is one CLI round trip holding the radio lock, so groups are collapsed and read on demand; "Read All" exists but is a long hold. Do not auto-read on expand.
