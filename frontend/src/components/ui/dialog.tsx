...
/**
 * The viewport cap and `overflow-y-auto` are the floor every dialog gets: without
 * them a dialog taller than the screen overflows off BOTH edges (it is centred by
 * translate) with no way to scroll -- the header, and with it the close button,
 * ends up above the top of the screen. A dialog that lays out its own scrolling
 * body overrides both through `cn()`, which keeps its own header pinned.
 */
